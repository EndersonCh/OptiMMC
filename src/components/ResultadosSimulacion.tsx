    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="p-4 bg-slate-50 rounded-lg border border-slate-100">
          ...
          <p className="text-3xl font-semibold text-slate-900 mt-2">{wqMinutos?.toFixed(1)} min</p>
        </div>
        <div className="p-4 bg-slate-50 rounded-lg border border-slate-100">
          <p className="text-sm text-slate-500 font-medium">Longitud de la fila (Lq)</p>
          <p className="text-3xl font-semibold text-slate-900 mt-2">{Math.round(lq || 0)} personas</p>
        </div>
        <div className="p-4 bg-slate-50 rounded-lg border border-slate-100">
          <p className="text-sm text-slate-500 font-medium">Utilizacion </p>
